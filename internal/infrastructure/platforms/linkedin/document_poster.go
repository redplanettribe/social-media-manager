...
func NewDocumentPoster(userSecrets UserSecrets, platformSecrets PlatformSecrets) *DocumentPoster {
...
func (dp *DocumentPoster) Post(ctx context.Context, pp *post.PublishPost, mediaList []*media.Media) error {
    ...
    setHeaders(initReq, dp.uSecrets.AccessToken)
    ...
    setBinaryHeaders(uploadReq, dp.uSecrets.AccessToken)
    ...
    setHeaders(postReq, dp.uSecrets.AccessToken)
