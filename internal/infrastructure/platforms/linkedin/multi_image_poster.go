...
func NewMultiImagePoster(userSecrets UserSecrets, platformSecrets PlatformSecrets) *MultiImagePoster {
...
func (mp *MultiImagePoster) Post(ctx context.Context, pp *post.PublishPost, mediaList []*media.Media) error {
    ...
    for i, m := range mediaList {
        ...
        go func(idx int, file *media.Media) {
            ...
            setHeaders(initReq, mp.uSecrets.AccessToken)
            ...
            setBinaryHeaders(uploadReq, mp.uSecrets.AccessToken)
    ...
    setHeaders(postReq, mp.uSecrets.AccessToken)
